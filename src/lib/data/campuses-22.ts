...
export const CAMPUSES: CampusData[] = [
    ...
    { id: 3, name: "Barker College", image: "/images/Campuses/barker.webp", label: "Partner School", description: "Partnership with Barker College delivering specialized enrichment programs.", address: "91 Pacific Hwy, Hornsby NSW 2077, Australia" },
    { id: 4, name: "Beecroft Public School", image: "/images/Campuses/beecroft.webp", label: "Partner School", description: "Collaborative programs with Beecroft Public School community.", address: "98 Beecroft Rd, Beecroft NSW 2119, Australia" },
    { id: 5, name: "Carlingford West Public School", image: "/images/Campuses/carlingford.webp", label: "Partner School", description: "Supporting students at Carlingford West with tailored academic programs.", address: "67 Felton Rd, Carlingford NSW 2118, Australia" },
    ...
    { id: 20, name: "KE Hong Kong", image: "/images/Campuses/hongkong.webp", label: "International", description: "Our Hong Kong campus bringing KE excellence to Asia.", address: "Hong Kong (香港)" },
    ...
    { id: 22, name: "KE Shang Hai", image: "/images/Campuses/shanghai.webp", label: "International", description: "Our Shanghai campus delivering premium educational programs.", address: "Shanghai, China (中国上海)" },
];
